class PlayRacko
  ...
  require_relative 'lib/turns/computer_player_racko_turn.rb'
  require_relative 'lib/turns/player_racko_turn.rb'
  require_relative 'lib/players/computer_player_brain.rb'
  require_relative 'lib/turns/racko_turn.rb'
